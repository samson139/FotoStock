    ...
    <div className="relative w-full h-screen bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 dark:from-gray-900 dark:via-gray-800 dark:to-black overflow-hidden">
      ...
      <div className="z-20 opacity-90 px-4 w-full mx-auto md:w-1/3 max-w-md p-6 rounded-2xl shadow-xl backdrop-blur-xl bg-white/80 border border-gray-300 dark:bg-white/10 dark:border-white/20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <FormInput label="First Name" name="firstname" type="text" onChange={inputHandler} placeholder="Firstname" />
          <FormInput label="Last Name" name="lastname" type="text" onChange={inputHandler} placeholder="Lastname" />
          <FormInput label="Email Address" name="email" type="email" onChange={inputHandler} placeholder="Email" />
          <FormInput label="Password" name="password" type="password" onChange={inputHandler} placeholder="Password" />
          <FormInput label="Confirm Password" name="confirmedPassword" type="password" onChange={inputHandler} placeholder="Confirmed Password" />
